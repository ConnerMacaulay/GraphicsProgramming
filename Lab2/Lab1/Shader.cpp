...
Shader::Shader(const std::string& filename)
{
	...
	shaders[0] = CreateShader(LoadShader("C:\\Users\\cmacau200\\Desktop\\Lab2\\Lab2\\res\\shader.vert"), GL_VERTEX_SHADER); // create vertex shader
	shaders[1] = CreateShader(LoadShader("C:\\Users\\cmacau200\\Desktop\\Lab2\\Lab2\\res\\shader.frag"), GL_FRAGMENT_SHADER); // create fragment shader
