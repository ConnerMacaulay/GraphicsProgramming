...
unsigned int OBJModel::FindLastVertexIndex(const vector<OBJIndex*>& indexLookup, const OBJIndex* currentIndex, const IndexedModel& result)
{
...
OBJIndex OBJModel::ParseOBJIndex(const string& token, bool* hasUVs, bool* hasNormals)
{
